...
[Kock--Lawvere 公理]: /trees/data-structure/synthetic-differential/kock-lawvere.md
...
如果 [Kock--Lawvere 公理] 成立, 则不可能有 $D = \{0\}$ [^impossible]. 因此我们可以使用排中律去假设存在非零的 $d_0 \in D$, 由 [Kock--Lawvere 公理] 得
